...
resource "aws_iam_policy_attachment" "admin-policy-attachment5" {
    name = "admin-policy-attachment5"
    policy_arn = "arn:aws:iam::aws:policy/IAMFullAccess"
    groups = ["${aws_iam_group.group.id}"]
}

resource "aws_iam_policy_attachment" "admin-policy-attachment6" {
    name = "admin-policy-attachment6"
    policy_arn = "arn:aws:iam::aws:policy/AmazonVPCFullAccess"
    groups = ["${aws_iam_group.group.id}"]
}

resource "aws_iam_group_policy" "admin-account-policy" {
